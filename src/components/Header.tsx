  ...
  return (
    <div className="bg-white md:border-b md:pb-1">
      <div className="bg-white bg m-auto w-[95%] md:w-11/12 py-2 md:h-full flex justify-between items-center">
        <div className="w-1/2 md:w-[30%] lg:w-[20%] flex justify-center items-center">
          <img
            src={Logo}
            alt="Company Logo"
        ...
        <div className="hidden md:flex md:w-[60%] lg:w-[51%] h-full md:border-2 border-black rounded-tl-2xl rounded-br-2xl">
          <form className="flex items-center justify-center w-full h-full">
            <div className="w-[30%] flex items-center justify-between py-2.5 pr-3">
              <h1 className="text-sm md:text-base">ទាំងអស់</h1>
            ...
            <div className="w-full">
              <input
                ...
                className="w-full border py-2.5 px-3 outline-none rounded-br-2xl"
              />
            </div>
          </form>
        </div>
      ...
      {showSearch && (
        <div className="w-11/12 md:hidden z-20 border m-auto rounded-br-2xl rounded-tl-2xl absolute top-20 left-4">
          <form className="flex items-center justify-center w-full h-full">
            <div className="w-1/4 flex items-center mr-1 justify-between py-2.5 pr-3 rounded-tl-2xl">
              <h1 className="text-sm">ទាំងអស់</h1>
            ...
            <div className="w-[68%]">
              <input
                type="search"
                placeholder="ស្វែងរកផលិតផល..."
                className="w-full border-none py-2.5 px-2 pr-3 outline-none rounded-br-2xl"
              />
            </div>
          </form>
        </div>
